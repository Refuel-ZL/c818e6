...
(function() {
	Ext.onReady(function() {
										...
										'Ext.window.Window',
										{
											...
											items : [
													...
													},
													{
														...
														cls : mod ? 'changepwd-button'
																: 'login-button',
														overCls : mod ? 'changepwd-button-over'
																: 'login-button-over',
														focusCls : mod ? 'changepwd-button-focus'
																: 'login-button-focus',
														handler : function(p,
																e, opt) {
															var user = Ext
				...
				var loadC818E6Page = function(id, n) {
					// $("iframe").hide(n, function() {
					localStorage['id'] = id;
					var el = Ext.get('c818e6_ip_cfg');
					if (el) {
						mask();
						var url = (id === 1 ? 'view/c818e6_ip_cfg.html'
								: 'view/c818e6_cfg.html');
						el.dom.src = url;
						var iframe = document.getElementById("c818e6_ip_cfg");
						var targelem = document
						...
						for ( var i = 0; i < aLi.length; i++) {
							...
							aLi[i].onclick = function() {
								...
								if (this.className != "active") { // 非活动页
									...
									this.className = "active"; // 活动页
									// 切换显示内容
									loadC818E6Page(this.index, 1000);
								}
							};
						}
					}
